...
def lambda_handler(event, context):
    ...
    vnetroutecidr = os.environ['VpcSummaryRoute'].split(',')
    ...
    if event['RequestType'] == 'Create':
        ...
        for route in vnetroutecidr:
            logger.info("Adding route {} to toTGWRouteTable ".format(route))
            res2 = add_route_tgw_nh(toTGWRouteTable, route, transit_gateway_id)
